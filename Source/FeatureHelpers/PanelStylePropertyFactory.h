...
struct PanelStylePropertyFactory {
    ...
    [[nodiscard]] constexpr cs2::CStylePropertyWidth* width(cs2::CUILength width) const noexcept
    {
        return create<cs2::CStylePropertyWidth>(width);
    }

    [[nodiscard]] constexpr cs2::CStylePropertyOpacity* opacity(float opacity) const noexcept
    {
        return create<cs2::CStylePropertyOpacity>(opacity);
    }

    [[nodiscard]] constexpr cs2::CStylePropertyZIndex* zIndex(float zIndex) const noexcept
    {
        return create<cs2::CStylePropertyZIndex>(zIndex);
    }

    [[nodiscard]] constexpr cs2::CStylePropertyHeight* height(cs2::CUILength height) const noexcept
    {
        return create<cs2::CStylePropertyHeight>(height);
    }

    [[nodiscard]] constexpr cs2::CStylePropertyImageShadow* imageShadow(const PanelShadowParams& params) const noexcept
    {
    ...
    [[nodiscard]] constexpr cs2::CStylePropertyPosition* position(cs2::CUILength x, cs2::CUILength y) const noexcept
    {
        return create<cs2::CStylePropertyPosition>(x, y, cs2::CUILength::pixels(0));
    }

    [[nodiscard]] constexpr cs2::CStylePropertyTransformOrigin* transformOrigin(cs2::CUILength x, cs2::CUILength y) const noexcept
    {
        return create<cs2::CStylePropertyTransformOrigin>(x, y, false);
    }

    [[nodiscard]] constexpr cs2::CStylePropertyAlign* align(cs2::EHorizontalAlignment horizontalAlignment, cs2::EVerticalAlignment verticalAlignment) const noexcept
    {
        return create<cs2::CStylePropertyAlign>(horizontalAlignment, verticalAlignment);
    }

    [[nodiscard]] constexpr cs2::CStylePropertyWashColor* washColor(cs2::Color color) const noexcept
    {
        return create<cs2::CStylePropertyWashColor>(color, true);
    }

    [[nodiscard]] constexpr cs2::CStylePropertyFlowChildren* flowChildren(cs2::EFlowDirection flowDirection) const noexcept
    {
        return create<cs2::CStylePropertyFlowChildren>(flowDirection);
    }

    [[nodiscard]] constexpr cs2::CStylePropertyFont* font(std::string_view fontFamily, float fontSize, cs2::EFontWeight fontWeight) const noexcept
    {
    ...
    [[nodiscard]] constexpr cs2::CStylePropertyTextShadow* textShadow(const PanelShadowParams& params) const noexcept
    {
    ...
    [[nodiscard]] constexpr cs2::CStylePropertyMargin* margin(cs2::CUILength left, cs2::CUILength top, cs2::CUILength right, cs2::CUILength bottom) const noexcept
    {
...
private:
    ...
    static constexpr T* create(Args&&... args) const noexcept
    {
