...
struct HookDependenciesBuilder {
    [[nodiscard]] HookDependenciesMask getConVarAccessor() const {
    ...
    [[nodiscard]] virtual HookDependenciesMask getFileSystem(cs2::CBaseFileSystem** fileSystem) const {
    ...
    [[nodiscard]] virtual HookDependenciesMask getSoundChannels(cs2::SoundChannels** soundChannels) const {
    ...
    [[nodiscard]] virtual HookDependenciesMask getPlantedC4(cs2::CPlantedC4** plantedC4) const {
    ...
    [[nodiscard]] virtual HookDependenciesMask getCurTime(float* curTime) const {
    ...
    [[nodiscard]] virtual HookDependenciesMask getFovScale(float* fovScale) const {
    ...
    [[nodiscard]] virtual HookDependenciesMask getLocalPlayerController(cs2::CCSPlayerController** localPlayerController) const {
    ...
    [[nodiscard]] HookDependenciesMask getEntityList(const cs2::CConcreteEntityList** entityList, cs2::CEntityIndex* highestEntityIndex) const {
